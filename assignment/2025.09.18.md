...
This week's assignment focuses on the comparative analysis of the optimization algorithms discussed in the lecture. The goal is to develop an intuition for why we might choose one optimizer over another in different scenarios. Please find the assignment and the corresponding solution report below.
